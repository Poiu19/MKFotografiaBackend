...
namespace MKFotografiaBackend.Migrations
{
    ...
    [Migration("20230108183711_FullOfferTeaser")]
    partial class FullOfferTeaser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MKFotografiaBackend.Entities.Offer", b =>
                {
                    ...
                    b.Property<int?>("ConnectedGalleryId")
                        .HasColumnType("int");

                    b.Property<int?>("ConnectedOfferId")
                        .HasColumnType("int");

                    b.Property<string>("FullOfferTeaser")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.Property<string>("TeaserDesktop")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<string>("TeaserMobile")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.HasKey("Id");

                    b.HasIndex("ConnectedGalleryId");
            ...
            modelBuilder.Entity("MKFotografiaBackend.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MKFotografiaBackend.Entities.SliderPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MKFotografiaBackend.Entities.Offer", b =>
                {
                    b.HasOne("MKFotografiaBackend.Entities.Gallery", "ConnectedGallery")
                        .WithMany()
                        .HasForeignKey("ConnectedGalleryId")
            ...
            modelBuilder.Entity("MKFotografiaBackend.Entities.User", b =>
                {
                    b.HasOne("MKFotografiaBackend.Entities.Role", "Role")
                        .WithMany()
